...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', () => {
        ...
        if (currentScroll > lastScrollTop && !navbar.classList.contains('scroll-down')) {
            navbar.classList.remove('scroll-up');
            navbar.classList.add('scroll-down');
        } else if (currentScroll < lastScrollTop && navbar.classList.contains('scroll-down')) {
    ...
    window.addEventListener('touchstart', addTouchClass, false);
});
